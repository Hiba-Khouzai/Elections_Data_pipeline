...
st.set_page_config(
    page_title="Dashboard Elections Presidentielles",
    page_icon="📊",
    layout="wide",
    initial_sidebar_state="collapsed",  # Adjust as needed
)
...
st.markdown(
    ...
    <style>
        body {
            background-color: #1E1E1E;  /* Set your preferred background color */
...
def update_data():
    ...
    col1.metric("Total electeurs", voters_count, delta=2.5, delta_color="inverse")
    col2.metric("Total Candidats", candidates_count, delta=-1.0, delta_color="inverse")
...
st.title('Dashboard Elections Présidentielles ')

usa_flag_image = "télécharger.png"  # Replace with the actual path or URL of the USA flag image
st.image(usa_flag_image, width=60)  # Adjust the width as needed
